 ...
 * payment Analytics Page - Enhanced with Dasher UI and Top Performing Clans
 */
...
if ($_SESSION['role'] !== 'super_admin') {
    setFlashMessage('error', 'Access denied. This page is for security guards only.');
...
// Super admin can see all clans' payment Analytics
// Clan admin can only see their clan's payment Analytics
...
<div class="content">
    ...
    <div class="content-header">
        <div class="d-flex justify-content-between align-items-start">
            <div>
                <h1 class="content-title">Payment Analytics</h1>
                        ...
                        <tr>
                            <td colspan="8" class="text-center py-4">
                                <div style="color: var(--text-muted);">
                                    ...
                                    <p>No payment Analytics found</p>
                                </div>
                            </td>
                        </tr>
                    <?php else: ?>
                ...
                <?php if (empty($monthlySummaries)): ?>
                    <div class="col-12">
                        <div class="empty-state">
                            ...
                            <h3>No payment Analytics found</h3>
...
document.addEventListener('DOMContentLoaded', function() {
    console.log('🎨 Initializing Dasher UI payment Analytics...');
    ...
    document.addEventListener('themeChanged', function(event) {
        console.log('🎨 Updating payment Analytics charts for theme:', event.detail.theme);
    ...
    console.log('✅ Dasher UI payment Analytics initialized successfully');
});
